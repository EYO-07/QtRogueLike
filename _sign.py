# --- From file: ./globals_variables.py (281 lines) ---
...
SPRITE_NAMES_WEAPONS = ['long_sword', 'bastard_sword', 'mace', 'crossbow', 'bolt']
SPRITE_NAMES_PLAYABLES = ['player', 'player_2', 'player_3']
SPRITE_NAMES_CHARACTERS = SPRITE_NAMES_PLAYABLES + ['zombie', 'zombie_2', 'bear', 'enemy', 'rogue', 'mercenary', 'swordman', 'upg_swordman', 'mounted_knight', 'evil_swordman', 'crossbowman', 'evil_crossbowman', 'sorceress', 'sorceress_2']
...
ZOMBIE_SPAWNER_LIST = [{'enemy': 'Zombie', 'chance': 0.25, 'b_generate_items': True, 'hp': 70}, {'enemy': 'Zombie', 'chance': 0.01, 'b_generate_items': True, 'hp': 100}, {'enemy': 'Zombie', 'chance': 0.75, 'b_generate_items': True}]
ROGUE_SPAWNER_LIST = [{'enemy': 'Mercenary', 'chance': 0.1, 'b_generate_items': True, 'extra_items': [{'item_name': 'WeaponRepairTool', 'name': 'Whetstone', 'uses': 5}, {'item_name': 'Food', 'name': 'meat', 'nutrition': 250}]}, {'enemy': 'RangedRaider', 'chance': 0.03, 'b_generate_items': True, 'sprite': 'evil_crossbowman', 'hp': 50}, {'enemy': 'Raider', 'chance': 0.01, 'b_generate_items': True, 'sprite': 'evil_swordman', 'hp': 100}, {'enemy': 'Rogue', 'chance': 0.3, 'b_generate_items': True, 'extra_items': [{'item_name': 'WeaponRepairTool', 'name': 'Whetstone', 'uses': 2}]}]
...
DEMON_SPAWNER_LIST = [{'enemy': 'Demon', 'chance': 0.45, 'b_generate_items': True}]
ENEMY_FACTION_LIST = [{'enemy': 'EnemyCrossbowman', 'chance': 0.25, 'b_generate_items': True}, {'enemy': 'Mercenary', 'chance': 0.05, 'b_generate_items': True, 'extra_items': [{'item_name': 'WeaponRepairTool', 'name': 'Whetstone', 'uses': 5}, {'item_name': 'Food', 'name': 'meat', 'nutrition': 250}]}, {'enemy': 'EnemySwordman', 'chance': 0.65, 'b_generate_items': True}]
...
# --- From file: ./reality.py (1543 lines) ---
...
class BehaviourCharacter(Entity):
    ...
    def find_path(self, start_x: int, start_y: int, goal_x: int, goal_y: int, game_instance): ...
...
# --- From file: ./mapping.py (1172 lines) ---
...
# --- From file: ./pyqt_layer_framework.py (188 lines) ---
...
# --- From file: ./artificial_behavior.py (696 lines) ---
...
def AB_flee_from_melee(char=None, game_instance=None): ...
def AB_dodge_from_melee(char=None, game_instance=None): ...
def AB_teleport_adjacent(char=None, game_instance=None): ...
...
# --- From file: ./special_tiles.py (1155 lines) ---
