# --- From file: ./globals_variables.py (268 lines) ---
...
ROGUE_SPAWNER_LIST = [{'enemy': 'Mercenary', 'chance': 0.05, 'b_generate_items': True, 'extra_items': [{'item_name': 'WeaponRepairTool', 'name': 'Whetstone', 'uses': 5}, {'item_name': 'Food', 'name': 'meat', 'nutrition': 250}]}, {'enemy': 'RangedRaider', 'chance': 0.03, 'b_generate_items': True, 'sprite': 'evil_crossbowman', 'hp': 50}, {'enemy': 'Raider', 'chance': 0.01, 'b_generate_items': True, 'sprite': 'evil_swordman', 'hp': 100}, {'enemy': 'Rogue', 'chance': 0.3, 'b_generate_items': True, 'extra_items': [{'item_name': 'WeaponRepairTool', 'name': 'Whetstone', 'uses': 2}]}]
...
# --- From file: ./reality.py (1487 lines) ---
...
# --- From file: ./mapping.py (1153 lines) ---
...
# --- From file: ./artificial_behavior.py (690 lines) ---
...
# --- From file: ./special_tiles.py (1020 lines) ---
# Failed to parse ./special_tiles.py: expected an indented block after function definition on line 31 (<unknown>, line 34)
