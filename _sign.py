# --- From file: ./QtRogueLike/globals_variables.py (185 lines) ---
...
# --- From file: ./QtRogueLike/reality.py (1409 lines) ---
...
class NPC(Entity):
    ...
    def npc_update(self, entities, game_instance, default_target=None): ...
class Character(Container, NPC):
...
class Player(Character, DefensiveCharacter, RegenerativeCharacter):
...
# --- From file: ./QtRogueLike/mapping.py (937 lines) ---
