...
SPRITE_NAMES = SPRITE_NAMES_WEAPONS + SPRITE_NAMES_CHARACTERS + SPRITE_NAMES_FOODS + SPRITE_NAMES_TILES + ['sack', 'HUD_arrow', 'whetstone', 'house', 'castle', 'lumber_mill', 'quarry', 'mill', 'wood', 'tower', 'red_flag', 'metal', 'stone', 'sorceress_tower']
...
# --- From file: ./reality.py (2161 lines) ---
