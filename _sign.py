# --- From file: ./globals_variables.py (204 lines) ---
...
SPRITE_NAMES_CHARACTERS = SPRITE_NAMES_PLAYABLES + ['zombie', 'zombie_2', 'bear', 'enemy', 'rogue', 'mercenary', 'swordman', 'mounted_knight', 'evil_swordman']
...
RAIDERS_TABLE = [{'enemy': 'Raider', 'chance': 0.75, 'b_generate_items': True, 'sprite': 'evil_swordman', 'hp': 200}]

# --- From file: ./game.py (1477 lines) ---
...
# --- From file: ./reality.py (2024 lines) ---
...
class Fireweapon(Weapon, SpecialSkillWeapon):
    def __init__(self, name='Crossbow', damage=7, description='', weight=1, stamina_consumption=1, durability_factor=0.995, ammo=0, range=12, projectile_sprite='bolt', ammo_type='bolt'): ...
...
# --- From file: ./mapping.py (936 lines) ---
...
# --- From file: ./pyqt_layer_framework.py (129 lines) ---
